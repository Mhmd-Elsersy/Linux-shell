...
void check_pipe(int pipe_no, char **parsed);
...
int main()
{
    ...
    pflag = back_process(parsed);   //check whether a background process is required or not
...
void check_pipe(int pipes_no, char **parsed)
{
